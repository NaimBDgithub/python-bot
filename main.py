...
def menu(id):
    ...
    bot.send_message(id, "*✔️ Home*", parse_mode="Markdown",
...
def start(message):
   try:
    ...
    if msg == '/start':
        ...
        msg_start = "* Welcome to our Official Bot on eth and bnb Network!
 Help spread the mystery & drive volume by inviting friends 🤑 Must Join Our All Channel - "
        for i in CHANNELS:
            msg_start += f"\n➡️ {i}\n"
        msg_start += "*"
